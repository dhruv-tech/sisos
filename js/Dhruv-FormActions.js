            ...
            success: function(data) {
                ...
                if ($data['result'] == "true") {
                    ...
                    if ($data['signed'] == "true") {
                        ...
                        messageEl.innerHTML = '<span><big>:) Already Logged In.</big><br><small>Remember to sign-out at Gate #3 at the time of departure.<small><span>';
                        classie.addClass(messageEl, 'show');
                        ...
                        messageEl.innerHTML = '<span><big>:) Successful.</big><br><small>Please sign-out at Gate #1 at the time of departure.<small><span>';
                        classie.addClass(messageEl, 'show');
                        $(messageEl).css('opacity', '1');
                        if ($data['admin'] == "true") {
                            integrator()
